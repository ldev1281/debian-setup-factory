...
#
{
    echo "HiddenServiceDir /var/lib/tor-instances/${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_NAME}"
...
_TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_URL="http://$(cat /var/lib/tor-instances/${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_NAME}/hostname)"

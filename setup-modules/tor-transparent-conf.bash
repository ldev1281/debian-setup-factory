...
TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_NAME="${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_NAME:=transparent}"
_TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_DIR="/var/lib/tor-instances/${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_NAME}"
TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_HOST="${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_HOST:=127.0.0.1}"
TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_PORT="${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_PORT:=80}"
TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_LISTEN="${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_LISTEN:=80}"
...
#
tor-instance-create ${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_NAME} || "failed to setup tor@${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_NAME}"
...
#
{
    ...
    echo ""
} >/etc/tor/instances/${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_NAME}/torrc

#
# Hidden Service
#
{
    echo "HiddenServiceDir ${_TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_DIR}"
    echo "HiddenServicePort ${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_LISTEN} ${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_HOST}:${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_PORT}"
    echo ""
} >>/etc/tor/instances/${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_NAME}/torrc
...
_TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_URL="http://$(cat ${_TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_DIR}/hostname)"
_TOR_TRANSPARENT_CONF_HS_TEST_ATTEMPTS=0
_TOR_TRANSPARENT_CONF_HS_TEST_RESTARTS=0
while ! curl --silent --fail ${_TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_URL} >/dev/null; do

...
TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_NAME="${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_NAME:=caddy}"
...
#
{
    echo "HiddenServiceDir /var/lib/tor/${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_NAME}_service"
...
TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_URL="http://$(cat /var/lib/tor/${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_NAME}_service/hostname)"
while ! curl --silent --fail ${TOR_TRANSPARENT_CONF_HIDDEN_SERVICE_URL} >/dev/null; do
    sleep 5

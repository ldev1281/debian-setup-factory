...
# Defaults
#
TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_NAME="${TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_NAME:=singlehop}"
_TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_DIR="/var/lib/tor/${TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_NAME}"
TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_FRP_HOST="${TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_HOST:=127.0.0.1}"
TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_FRP_PORT="${TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_PORT:=7000}"
TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_FRP_LISTEN="${TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_LISTEN:=7000}"
TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_DANTE_HOST="${TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_HOST:=127.0.0.1}"
TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_DANTE_PORT="${TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_PORT:=1080}"
TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_DANTE_LISTEN="${TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_LISTEN:=1080}"
...
# Enable hidden service in single hop mode and include configs with %include option
{
    ...
    echo "HiddenServiceDir ${_TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_DIR}"
...
{
    echo "# FRP server"
    echo "HiddenServicePort ${TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_FRP_LISTEN} ${TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_FRP_HOST}:${TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_FRP_PORT}"
    echo ""
...
#
{
    ...
    echo "HiddenServicePort ${TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_DANTE_LISTEN} ${TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_DANTE_HOST}:${TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_DANTE_PORT}"
    echo ""
...
while [ ! -f "$_TOR_SINGLEHOP_CONF_HIDDEN_SERVICE_DIR/hostname" ] >/dev/null; do

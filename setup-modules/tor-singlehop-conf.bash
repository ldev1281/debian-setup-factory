...
TOR_SINGLEHOP_CONF_HS_FRP_HOST="${TOR_SINGLEHOP_CONF_HS_HOST:=127.0.0.1}"
TOR_SINGLEHOP_CONF_HS_FRP_PORT="${TOR_SINGLEHOP_CONF_HS_PORT:=7000}"
TOR_SINGLEHOP_CONF_HS_FRP_LISTEN="${TOR_SINGLEHOP_CONF_HS_LISTEN:=7000}"
TOR_SINGLEHOP_CONF_HS_DANTE_HOST="${TOR_SINGLEHOP_CONF_HS_HOST:=127.0.0.1}"
TOR_SINGLEHOP_CONF_HS_DANTE_PORT="${TOR_SINGLEHOP_CONF_HS_PORT:=1080}"
TOR_SINGLEHOP_CONF_HS_DANTE_LISTEN="${TOR_SINGLEHOP_CONF_HS_LISTEN:=1080}"

...
TOR_SINGLEHOP_CONF_HS_THREEPROXY_HOST="${TOR_SINGLEHOP_CONF_HS_THREEPROXY_HOST:=127.0.0.1}"
TOR_SINGLEHOP_CONF_HS_THREEPROXY_SOCKS_PORT="${TOR_SINGLEHOP_CONF_HS_THREEPROXY_SOCKS_PORT:=1081}"
TOR_SINGLEHOP_CONF_HS_THREEPROXY_HTTP_PORT="${TOR_SINGLEHOP_CONF_HS_THREEPROXY_HTTP_PORT:=3128}"
TOR_SINGLEHOP_CONF_HS_THREEPROXY_SMTP_PORT="${TOR_SINGLEHOP_CONF_HS_THREEPROXY_SMTP_PORT:=587}"
TOR_SINGLEHOP_CONF_HS_THREEPROXY_SOCKS_LISTEN="${TOR_SINGLEHOP_CONF_HS_THREEPROXY_SOCKS_LISTEN:=1081}"
TOR_SINGLEHOP_CONF_HS_THREEPROXY_HTTP_LISTEN="${TOR_SINGLEHOP_CONF_HS_THREEPROXY_HTTP_LISTEN:=3128}"
TOR_SINGLEHOP_CONF_HS_THREEPROXY_SMTP_LISTEN="${TOR_SINGLEHOP_CONF_HS_THREEPROXY_SMTP_LISTEN:=587}"
...
{
    echo "# Tor configuration (Single Hop) for Dante, FRP, threeproxy"
    echo ""
...
#
# Threeproxy port forwarding (SOCKS5, HTTP, SMTP)
#
{
    echo "# threeproxy SOCKS5"
    echo "HiddenServicePort ${TOR_SINGLEHOP_CONF_HS_THREEPROXY_SOCKS_LISTEN} ${TOR_SINGLEHOP_CONF_HS_THREEPROXY_HOST}:${TOR_SINGLEHOP_CONF_HS_THREEPROXY_SOCKS_PORT}"
    echo "# threeproxy HTTP"
    echo "HiddenServicePort ${TOR_SINGLEHOP_CONF_HS_THREEPROXY_HTTP_LISTEN} ${TOR_SINGLEHOP_CONF_HS_THREEPROXY_HOST}:${TOR_SINGLEHOP_CONF_HS_THREEPROXY_HTTP_PORT}"
    echo "# threeproxy SMTP"
    echo "HiddenServicePort ${TOR_SINGLEHOP_CONF_HS_THREEPROXY_SMTP_LISTEN} ${TOR_SINGLEHOP_CONF_HS_THREEPROXY_HOST}:${TOR_SINGLEHOP_CONF_HS_THREEPROXY_SMTP_PORT}"
} >/etc/tor/instances/${TOR_SINGLEHOP_CONF_HS_NAME}/torrc.d/30-threeproxy.conf
...
TOR_SINGLEHOP_CONF_HS_FRP_HOSTNAME="${TOR_SINGLEHOP_CONF_HS_HOSTNAME}"
TOR_SINGLEHOP_CONF_HS_DANTE_HOSTNAME="${TOR_SINGLEHOP_CONF_HS_HOSTNAME}"
TOR_SINGLEHOP_CONF_HS_THREEPROXY_HOSTNAME="${TOR_SINGLEHOP_CONF_HS_HOSTNAME}"

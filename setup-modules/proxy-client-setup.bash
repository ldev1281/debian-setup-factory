...
#
MODULE_NAME="${MODULE_NAME:-proxy-client}"
REPO_URL="${REPO_URL:-https://github.com/ldev1281/docker-compose-proxy-client.git}"
TARGET_PARENT_DIR="${TARGET_PARENT_DIR:-/docker}"
TARGET_DIR="${TARGET_DIR:-${TARGET_PARENT_DIR}/proxy-client}"
